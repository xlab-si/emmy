...
// SchnorrProof presents all three messages in sigma protocol - useful when challenge
...
func NewSchnorrProof(proofRandomData, challenge *big.Int,
	proofData []*big.Int) *SchnorrProof {
	return &SchnorrProof{
