...
// DFMultiplicationProof presents all three messages in sigma protocol - useful when challenge
// is generated by prover via Fiat-Shamir.
type DFMultiplicationProof struct {
...
func NewDFMultiplicationProof(proofRandomData1, proofRandomData2, challenge, proofDataU1, proofDataU,
	proofDataV1, proofDataV2, proofDataV3 *big.Int) *DFMultiplicationProof {
	return &DFMultiplicationProof{
...
func (v *DFCommitmentMultiplicationVerifier) SetChallenge(challenge *big.Int) {
