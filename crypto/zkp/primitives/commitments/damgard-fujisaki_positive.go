...
// DFPositiveProof presents all three messages in sigma protocol - useful when challenge
// is generated by prover via Fiat-Shamir.
type DFPositiveProof struct {
	ProofRandomData []*big.Int
	Challenges      []*big.Int
	ProofData       []*big.Int
}

func NewDFPositiveProof(proofRandomData, challenges, proofData []*big.Int) *DFPositiveProof {
	return &DFPositiveProof{
...
func (v *DFCommitmentPositiveVerifier) SetChallenges(challenges []*big.Int) {
	for i, v := range v.squareVerifiers {
